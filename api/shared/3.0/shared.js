...
(function (window) {
	...
	mcdep.checkMobile = function(forceMobile) {
		...
		if (mcdep._mobile) return true;

		return check;
	}

	// distinguish between a few popular mobile user agents, desktop agents, and IE
	mcdep.whatDevice = function (forceMobile) {

		if (mcdep._mobile) return mobile;
...
.factory('global', ['$sce', function ($sce) {
	...
	var isMobile = function () {
		return mcdep.checkMobile();
	}

	// angular wrapper for the above function
	var checkDevice = function () {
	 	return mcdep.whatDevice();
	}
