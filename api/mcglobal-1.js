...
/***********************************************************************************
		...
		JavaScript library with no dependencies	
...
(function (window) {
	...
	mcshared.desktop = "desktop";
	mcshared.mobile = "mobile";
	mcshared.ie = "internet explorer";

	mcshared._mobile = false;
	...
	mcshared.checkMobile = function(forceMobile) {
		var check = false;
	...
	mcshared.utility = {
		...
		waitForElem:function (options, complete) {
